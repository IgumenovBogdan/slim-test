...
class TestPostRepository implements PostRepository
{
    ...
    public function __construct(array $posts = null)
    {
        $this->posts  = $posts ?? [
            ...
            2 => new Post(2, 'The best countries in the world', 'Really long text about countries...', 3),
            3 => new Post(3, 'Work hard, get better', 'Really long text about self-development...', 65),
        ];
    }
